    ...
    questions: [
      {
        ...
        answer: [
          ...
          { type: 'p', text: 'One condition, and it is what the multiplier is really for: each call has to be made ahead of the match it builds on. A round only extends your run if you committed that pick before your player’s previous match got under way — while they were still in the draw because you put them there. Waiting for a match to finish and then picking whoever won is not a prediction, and it earns base points at ×1.' },
        ...
        answer: [
          { type: 'p', text: 'Four things end a run:' },
          {
            ...
            items: [
              ...
              'You committed the pick after your player’s previous match had already started. From that point they were a result you could watch rather than a call you were making, so the run begins again there.',
            ],
          },
      ...
      },
      {
        ...
        answer: [
          ...
          { type: 'p', text: 'The other reason is timing. If you committed the pick only after your player’s previous match had started, the call was made on a match you could watch rather than on your own projection, so it pays at ×1 and the run restarts. The cut-off is whichever came first: the match being locked as it started, or its result going in.' },
