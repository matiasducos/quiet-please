    ...
    questions: [
      {
        ...
        answer: [
          ...
          { type: 'p', text: 'One condition, and it is what the multiplier is really for: the multiplier counts how many rounds below a pick were still undecided at the moment you committed it. Lock your semifinal pick before your player has played a match and all four rounds beneath it are still open, so it pays ×5 if they get there. Lock the same pick once they are already through to the quarterfinals and only one round is still open, so it pays ×2.' },
          { type: 'p', text: 'That is the whole idea: you are paid for what was actually at stake when you called it. Building a run one round at a time — waiting to see your player through, then backing them for the next match — is a smaller risk than calling the whole run in advance, and it now pays accordingly.' },
          { type: 'p', text: 'On the bracket, a player you have projected into a later round is shown with diagonal shading. Committing a pick on a shaded player is what builds the multiplier; a player already through on a real result is drawn plain.' },
        ...
        answer: [
          { type: 'p', text: 'Four things end a run:' },
          {
            ...
            items: [
              ...
              'A round below the pick had already been decided when you committed it. Your run only counts back as far as what was still unknown at that moment — everything below a result you could already see was not a call you were making.',
            ],
          },
      ...
      },
      {
        ...
        answer: [
          ...
          { type: 'p', text: 'The other reason is timing. The multiplier counts only the rounds that were still undecided when you committed, so a pick locked after your player’s previous match had gone pays ×1 no matter how long you have been backing them. The cut-off for each round is whichever came first: the match being locked as it started, or its result going in.' },
