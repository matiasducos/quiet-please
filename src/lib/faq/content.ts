    ...
    questions: [
      {
        ...
        answer: [
          ...
          { type: 'p', text: 'One condition, and it is what the multiplier is really for: each call has to be made ahead of the result it builds on. A round only extends your run if you committed that pick while the previous round was still undecided — while your player was still there because you put them there. Waiting for a round to finish and then picking whoever just won is not a prediction, and it earns base points at ×1.' },
        ...
        answer: [
          { type: 'p', text: 'Four things end a run:' },
          {
            ...
            items: [
              ...
              'You committed the pick after the previous round had already been decided. At that point your player was a known winner, not a prediction, so the run starts again from there.',
            ],
          },
      ...
      },
      {
        ...
        answer: [
          ...
          { type: 'p', text: 'The other reason is timing. If you committed the pick only after the previous round had been decided, the call was made on a known result rather than on your own projection, so it pays at ×1 and the run restarts.' },
