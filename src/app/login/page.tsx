...
import { showFacebookLogin } from '@/lib/auth-providers'
...
const AUTH_ERRORS: Record<string, string> = {
  ...
  // Split out of auth_callback_failed once /auth/callback started reading the
  // provider's own reason. The old copy guessed at the email permission for
  // every failure, including the ones where the person simply pressed cancel.
  provider_no_email:
    'Facebook completed the sign-in but did not share an email address, so the account '
    + 'could not be created. Try again and leave the email permission ticked — or sign '
    + 'in with Google instead.',
  oauth_declined:
    'That sign-in was cancelled before it finished, so nothing was created. You can try again.',
  reset_link_invalid:
      ...
      <div className="flex-1 flex flex-col justify-center px-8 sm:px-16">
        <div className="max-w-sm w-full mx-auto">
          ...
          <div className="flex flex-col gap-3">
            ...
            {showFacebookLogin(searchParams) && (
