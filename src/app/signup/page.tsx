      ...
      <div className="flex-1 flex flex-col justify-center px-8 sm:px-16">
        <div className="max-w-sm w-full mx-auto">
          ...
          <div className="flex flex-col gap-3">
            ...
            <button onClick={handleFacebookSignup} className="w-full py-3 text-sm font-medium rounded-sm hover:opacity-90 flex items-center justify-center gap-2.5 transition-opacity" style={{ background: '#1877F2', color: 'white', border: 'none' }}>
